  ...
  return (
    <ScrollView contentContainerStyle={styles.container}>
      ...
      <Text style={styles.paragraph}>
        These terms and conditions apply to the YumYap app (hereby referred to
        as "Application") for mobile devices that was created by John McCants
        (hereby referred to as "Service Provider") as a Freemium service. Upon
        downloading or utilizing the Application, you are automatically agreeing
        to the following terms. It is strongly advised that you thoroughly read
        and understand these terms prior to using the Application. Unauthorized
      ...
      <Text style={styles.paragraph}>
        ...
        the new Terms and Conditions on this page. These terms and conditions
        are effective as of 2024-05-15
      </Text>
